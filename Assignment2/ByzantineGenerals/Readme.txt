Problem:
The byzantine generals problem by lamport is about reaching a consensus of decision, whether to attack or to retreat. The commander takes a decision as to what he wants to do, and then the respective lieutenants need to pick whether they vote to agree or retreat. A disloyal lieutenant always goes against the current vote, while a loyal lieutenant agrees with the decision. If there is a tie in the votes, then the vote is a tie result and no action is taken! The best case situation is that there are no traitors in the lieutenants, causing for the generals decision to be taken every time.
